...
exports.users = exports.directory = void 0;
...
function busqueda(empresa, descripcionS) {
    if (empresa === void 0) { empresa = "AEF"; }
    var encontrada = [];
    var i = 0;
    while (i < corridasWeb.length) {
        if (corridasWeb[i].empresa == empresa && corridasWeb[i].descripcionServicio == descripcionS) {
            encontrada.push(new empresa_1["default"](corridasWeb[i].numeroCorrida, corridasWeb[i].descripcionServicio, corridasWeb[i].empresa, corridasWeb[i].descripcionEmpresa, (corridasWeb[i].listaDescuentos !== undefined ? true : false)));
        }
        i++;
    }
...
console.log(123);
var usuario = new Usuario_1.User("", "", "", "").encontrado('ricardo.jimenez@axity.com');
console.log(usuario);
